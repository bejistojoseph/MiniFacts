  ...
  kitchen: [
    {
      ...
      description:
        "Add a marshmallow or a slice of bread to the container to prevent hardening.",
      icon: "🍞",
    },
    {
      id: "k2",
      ...
      description:
        "Use ice cube trays to freeze herbs in olive oil for easy cooking portions.",
      icon: "🌿",
    },
    {
      id: "k3",
      ...
      description:
        "Push a straw through the stem end to remove the pit cleanly.",
      icon: "🍒",
    },
    {
      id: "k4",
      ...
      description:
        "Microwave stale chips or crackers for 10 seconds with a damp paper towel.",
      icon: "🍪",
    },
    {
      id: "k5",
      ...
      description:
        "Peel ginger easily with a spoon—the skin scrapes right off!",
      icon: "🥄",
    },
    {
      id: "k6",
    ...
    },
    {
      ...
      description:
        "Store with a slice of bread (the cake absorbs its moisture).",
      icon: "🍰",
    },
    {
      id: "k11",
  ...
  home: [
    {
      ...
      description:
        "Use a tension rod under the sink to hang spray bottles and save space.",
      icon: "🧴",
    },
    {
      id: "h2",
      ...
      description:
        "Store bed sheets inside their matching pillowcase to keep sets organized.",
      icon: "🛏️",
    },
    {
      id: "h3",
      ...
      description:
        "Label cords with bread clips—write the device name on them and slide them onto wires.",
      icon: "🔌",
    },
    {
      id: "h4",
      ...
      description:
        "Turn a muffin tin upside down to hold small items (nails, beads, etc.) while working.",
      icon: "🧁",
    },
    {
      id: "h5",
      ...
      description:
        "Use a coffee filter to clean TV screens—it's lint-free and gentle.",
      icon: "📺",
    },
    {
      id: "h6",
  ...
  tech: [
    {
      ...
      description:
        "Ping your phone even when on silent via Find My Device on your smartwatch.",
      icon: "⌚",
    },
    {
      id: "t2",
    ...
    },
    {
      ...
      description:
        "Charge your phone faster by switching to airplane mode while charging.",
      icon: "✈️",
    },
    {
      id: "t4",
    ...
    },
    {
      ...
      description:
        "Use toothpaste to buff out small phone scratches (works on plastic screens).",
      icon: "🪥",
    },
  ],
  money: [
    {
      ...
      description:
        "Boil pasta in less water—it cooks just as well and saves energy.",
      icon: "🍝",
    },
    {
      id: "m2",
      ...
      description:
        "Make your own with baking soda, grated soap, and washing soda.",
      icon: "🧺",
    },
    {
      id: "m3",
      ...
      description:
        "Use a rubber band to open stuck jars—wrap it around the lid for extra grip.",
      icon: "🫙",
    },
    {
      id: "m4",
  ...
  travel: [
    {
      ...
      description:
        "Roll clothes instead of folding to save luggage space and prevent wrinkles.",
      icon: "👕",
    },
    {
      id: "tr2",
      ...
      description:
        "Use a shower cap to cover shoes in your suitcase and keep clothes clean.",
      icon: "👟",
    },
    {
      id: "tr3",
      ...
      description:
        "Bookmark Google Maps offline before traveling to avoid data charges.",
      icon: "🗺️",
    },
    {
      id: "tr4",
      ...
      description:
        "If a task takes less than 2 minutes, do it immediately rather than later.",
      icon: "⏱️",
    },
    {
      id: "tr5",
      ...
      description:
        "Drink water before bed to naturally wake up earlier without an alarm.",
      icon: "💧",
    },
    {
      id: "tr6",
    ...
    },
    {
      ...
      title: "Focus Hack",
      description:
        "Wear headphones (even without music) to avoid interruptions.",
      icon: "🎧",
    },
    {
      id: "tr14",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl mb-8">
                Smart shortcuts and creative solutions to make everyday life
                easier
              </p>
              ...
              {lifehacksData[activeCategory].map((hack) => (
                <div
                  ...
                  className={`p-6 rounded-xl border ${
                    ...
                    categories.find((cat) => cat.id === activeCategory).bgColor
